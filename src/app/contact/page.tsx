...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-[#324f7a]/5">
      {/* Hero Section */}
      <section className="border-b border-border/40 bg-[#324f7a] py-16 text-white">
            ...
            <div className="lg:col-span-2">
              <Card className="h-full bg-white shadow-lg">
                <CardContent className="p-8">
                  <h2 className="mb-6 text-2xl font-bold text-[#324f7a]">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex gap-4">
                      <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-[#f2a63b]">
                        <Phone className="h-6 w-6 text-white" />
                      </div>
                      <div>
                        <p className="font-semibold text-[#324f7a]">
                          {locale === "en" ? "Phone" : "電話"}
                        </p>
                        <a
                          href="tel:+15103335943"
                          className="text-gray-600 hover:text-[#f2a63b]"
                        >
                          (510) 333-5943
                        </a>
                      </div>
                  ...
                  {/* CTA */}
                  <div className="mt-8 rounded-lg bg-[#324f7a]/5 p-6">
                    <p className="mb-4 font-semibold text-[#324f7a]">
                      {locale === "en"
                        ? "Ready to visit?"
                        : "準備好參觀了嗎？"}
                    </p>
                    <Button
                      asChild
                      className="w-full bg-[#f2a63b] hover:bg-[#f2a63b]/90"
                    >
